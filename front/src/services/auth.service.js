import { postLogin, postSignup } from "../api/auth.instance";
import { setAuthToken } from "../api/default.instance";
import { getUser } from "../api/user.instance";
...
export const signup = async (data) => {
  ...
  try {
    const res = await postSignup(mydata);
    if (res?.status === 400) {
